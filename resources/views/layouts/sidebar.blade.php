    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-1 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
        ...
        @if($isSuperadmin || $isAdmin)
            ...
            <div id="keanggotaan-menu" class="space-y-1">
                ...
                <a href="{{ route('kta-templates.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-all {{ request()->routeIs('kta-templates.index') ? 'bg-gradient-to-r from-[#3E9A3E] to-[#85C955] text-white hover:from-[#358935] hover:to-[#75B945]' : '' }}">
                    <i class="fas fa-id-badge text-base {{ request()->routeIs('kta-templates.index') ? 'text-white' : 'text-[#3E9A3E]' }}"></i>
        ...
        @if($isSuperadmin || $isAdmin || $isPengurus)
            ...
            <div id="publikasi-menu" class="space-y-1">
                ...
                <a href="{{ route('organization.history.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-all {{ request()->routeIs('organization-history.index') ? 'bg-gradient-to-r from-[#3E9A3E] to-[#85C955] text-white hover:from-[#358935] hover:to-[#75B945]' : '' }}">
                    <i class="fas fa-info-circle text-base {{ request()->routeIs('organization-history.index') ? 'text-white' : 'text-[#3E9A3E]' }}"></i>
