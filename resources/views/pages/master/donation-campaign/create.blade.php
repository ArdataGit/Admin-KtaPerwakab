...
@section('page-title', 'Tambah Campaign Donasi')
...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Tambah Campaign Donasi</h2>
            <p class="text-sm text-gray-600 mt-1">Buat campaign donasi baru</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <div class="bg-gradient-to-r from-[#3E9A3E] to-[#85C955] p-6">
            <h3 class="text-xl font-semibold text-white">
                <i class="fas fa-plus-circle mr-2"></i>Form Tambah Campaign Donasi
            </h3>
        </div>

        <form action="{{ route('master.donation-campaign.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
