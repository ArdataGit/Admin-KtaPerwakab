                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($users as $i => $u)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-4 py-3 text-gray-700">{{ $users->firstItem() + $i }}</td>
                            <td class="px-4 py-3">
                                <span class="px-2 py-1 rounded-full text-xs font-medium {{ $u->role == 'anggota' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700' }}">
                                    {{ ucfirst($u->role) }}
                                </span>
                            </td>
