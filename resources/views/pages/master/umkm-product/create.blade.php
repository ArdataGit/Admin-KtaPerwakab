...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <form action="{{ route('umkm.products.store', $umkm->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf

            @include('pages.master.umkm-product.form', ['data' => null, 'umkm' => $umkm])
